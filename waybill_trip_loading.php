<?php
/**
 * صفحهٔ فقط-لودینگ برای ثبت «شروع/پایان سفر» — آدرس مجزا از waybill_geofence_check.php
 *
 * ورودی (GET): فقط و فقط «token» (همان توکن یک‌بارمصرف عملیات که در
 * waybill_geofence_check.php پس از تایید حصار جغرافیایی ساخته شده است).
 *
 ...
 * api/trip_action.php درخواست می‌زند. کاربر همیشه روی همین صفحه/آدرس
 * می‌ماند — هیچ ریدایرکتی به صفحهٔ دیگر انجام نمی‌شود.
 */
...
<style>
  ...
  /* فضای کافی دور اسپینر تا چرخش/سایه‌ها با متن زیرش تلاقی نداشته باشد */
  .loader-shell {
    width: 90px;
    height: 90px;
    display: flex;
...
(function () {
  ...
  var TRIP_ACTION_URL = '<?= BASE_URL ?>/api/trip_action.php';
  ...
  // عمداً هیچ ریدایرکت یا بازگشتی وجود ندارد؛ کاربر روی همین صفحه می‌ماند.
})();
</script>
</body>
</html>
